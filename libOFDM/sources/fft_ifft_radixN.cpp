...
///////////////////
    ...
    for(int i=0; i<N; i++)
    {
        ...
        //c2=0;
        tab2[i].real(*(txdataF+2*i));
        tab2[i].imag(*(txdataF+2*i+1));
    ...
    if(mod == 0)
    {
        ...
        for(int i=0; i<N; ++i)
        {
            *(txdata +2*i) = tab2[i].real();
            *(txdata +2*i+1) = tab2[i].imag();
...
//    system("pause");
//
//    cout<<"frequency Hz from iDFT"<<endl;
//    cout<<"tab2[j].real():"<<endl;
//    for(int j=0;j<N;j++)
//    {
//    cout.precision(4);
